...
<body>
            ...
            <ul class="space-y-2 font-medium">
                ...
                <li>
                    <a href="{{ route('admin.books') }}"
                        ...
                        <span class="flex-1 ms-3 whitespace-nowrap">Libros</span>
                    </a>
                </li>
                <li>
    ...
    <div class="p-4 sm:ml-64">
        <div class="px-4  border-gray-200 border-dashed rounded-lg dark:border-gray-700">
            <h1
                class="self-center text-xl font-semibold whitespace-nowrap dark:text-white border-b-2 mb-5 border-black">
                Libros
            </h1>

            <!-- Modal toggle -->
            <button data-modal-target="authentication-modal" data-modal-toggle="authentication-modal"
                class="focus:outline-none text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-5 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800"
                type="button">
                Crear Libro
            </button>
            <!-- Main modal -->
